...
The latest version is **1.0.2**, See the [changelog](CHANGELOG.html). If you want to see the changes between your PDF and the latest PDF, you could use this online tool <https://tools.pdf24.org/en/compare-pdf>.
